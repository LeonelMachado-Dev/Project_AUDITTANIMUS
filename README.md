...
AudittAnimus is a fan project maded to bring the Assassin's Creed 2 animus atmosphere. Basicly is a database completly inspired in the design of the animus 2.0, where the user will storage subjects, locations and memories. This is just like a local google drive cloud (something like that... what i mean is this is like a offline cloud).
